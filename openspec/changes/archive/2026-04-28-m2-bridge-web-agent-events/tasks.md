...
- [x] 7.3 Run `/opsx-archive m2-bridge-web-agent-events` (or `npx @fission-ai/openspec archive m2-bridge-web-agent-events`) to fold the new spec into `openspec/specs/web-agent-bridge/` and move this change to `openspec/changes/archive/`
